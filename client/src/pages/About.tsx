  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
      ...
      <motion.div
        ...
        className="mt-20"
      >
        <h2 className="text-2xl font-bold text-slate-900 text-center mb-12">Отзывы пользователей</h2>

        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <Card className="bg-slate-50 rounded-xl p-8 shadow-neomorphic-sm">
            <CardContent className="p-0">
              ...
              <p className="text-slate-700 mb-6">
                "Переоформляшка спасла мою курсовую работу! Исправила все ошибки и отформатировала по
                ГОСТу, преподаватель был в восторге. Рекомендую!"
              </p>
              <div className="flex items-center">
                ...
                <div className="ml-3">
                  <h4 className="text-sm font-medium text-slate-900">Анна Смирнова</h4>
                  <p className="text-xs text-slate-500">Студентка, МГУ</p>
                </div>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="bg-slate-50 rounded-xl p-8 shadow-neomorphic-sm">
            <CardContent className="p-0">
              ...
              <p className="text-slate-700 mb-6">
                "Как преподаватель, я рекомендую этот сервис своим студентам. Он не только исправляет
                ошибки, но и помогает понять, как правильно оформлять работы."
              </p>
              <div className="flex items-center">
                <div className="h-10 w-10 rounded-full bg-primary-100 flex items-center justify-center text-primary-700 font-medium">
                  ИП
                ...
                <div className="ml-3">
                  <h4 className="text-sm font-medium text-slate-900">Игорь Петров</h4>
                  <p className="text-xs text-slate-500">Доцент, СПБГУ</p>
                </div>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="bg-slate-50 rounded-xl p-8 shadow-neomorphic-sm">
            <CardContent className="p-0">
              ...
              <p className="text-slate-700 mb-6">
                "Очень удобный сервис! Диплом оформлен идеально, все источники и цитаты проверены и
                отформатированы согласно требованиям. Большое спасибо команде!"
              </p>
              <div className="flex items-center">
                <div className="h-10 w-10 rounded-full bg-primary-100 flex items-center justify-center text-primary-700 font-medium">
                  МК
                ...
                <div className="ml-3">
                  <h4 className="text-sm font-medium text-slate-900">Максим Ковалев</h4>
                  <p className="text-xs text-slate-500">Выпускник, МГТУ</p>
                </div>
              </div>
            </CardContent>
          </Card>
